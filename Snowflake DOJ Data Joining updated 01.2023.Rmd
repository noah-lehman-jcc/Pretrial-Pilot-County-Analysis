...
#save(sf_df, file = "C:/Work/Pretrial-Pilot-County-Analysis/Snowflake extract for joining 10.18.22.RData")
save(sf_df, file = "C:/Work/Pretrial-Pilot-County-Analysis/Snowflake extract for joining 1.12.23.RData")
...
#save(full_df, file = "SF DOJ Joined 10.18.22.RData")
save(full_df, file = "SF DOJ Joined 1.12.23.RData")
...
#save(match_df_2022, file = "Match df 10.18.22.RData")
save(match_df_2022, file = "Match df 1.12.23.RData")
...
#save(eval_df, file = "Eval df 10.18.22.RData")
save(eval_df, file = "Eval df 1.12.22.RData")
...
#save(all_with_doj_and_recid, file = "All with recid 10.18.22.RData")
save(all_with_doj_and_recid, file = "All with recid 1.12.23.RData")
...
# fwrite(test_doj, file="G:/CrimJustice/PretrialAssessmentPilot/ADLS Load/test_doj_fw 10.18.22.csv")
# save(test_doj, file = "G:/CrimJustice/PretrialAssessmentPilot/ADLS Load/final_doj_for_upload to sf 10.18.22.RData")

fwrite(test_doj, file="G:/CrimJustice/PretrialAssessmentPilot/ADLS Load/test_doj_fw 1.12.23.csv")
save(test_doj, file = "G:/CrimJustice/PretrialAssessmentPilot/ADLS Load/final_doj_for_upload to sf 1.12.23.RData")
