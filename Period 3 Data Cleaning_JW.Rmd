...
save(book_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Calaveras Booking Collapse.RData")
```
...
court_person2 <- read_excel("Historical Data Submissions/Calaveras/P3 Submission-Jan 15/TECH_ELEMENTS_CALAVERAS.xlsx", col_types = "text")

court_person <- court_person %>%
  bind_rows(court_person2) %>%
  distinct()
...
court_charge2 <- read_excel("Historical Data Submissions/Calaveras/P3 Submission-Jan 15/Charges_CALAVERAS.xlsx", col_types = "text")

court_charge <- court_charge %>%
  bind_rows(court_charge2) %>%
  distinct()
...
court_hearing2 <- read_excel("Historical Data Submissions/Calaveras/P3 Submission-Jan 15/HEARINGS_CALAVERAS.xlsx", col_types = "text")

court_hearing <- court_hearing %>%
  bind_rows(court_hearing2) %>%
  distinct()
...
#   distinct()
  ...
  ## Use period 3 data to replace historical data submission.
court_fta_war <- read_excel("Historical Data Submissions/Calaveras/P3 Submission-Jan 15/WARRANTS_CALAVERAS.xlsx", col_types = "text")
...
court_sent2 <- read_excel("Historical Data Submissions/Calaveras/P3 Submission-Jan 15/SENT_CONF_CALAVERAS.xlsx", col_types = "text")
...
court_probation2 <- read_excel("Historical Data Submissions/Calaveras/P3 Submission-Jan 15/SENT_PROB_CALAVERAS.xlsx", sheet = 1, col_types = "text")

court_probation <- court_probation %>%
  bind_rows(court_probation2) %>%
  distinct()
...
court_dl_cond2 <- read_excel("Historical Data Submissions/Calaveras/P3 Submission-Jan 15/SENT_DL_COND_CALAVERAS.xlsx", col_types = "text")

court_dl_cond <- court_dl_cond %>%
  bind_rows(court_dl_cond2) %>%
  distinct()
...
save(court_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Calaveras Court Collapse.RData")
```
...
save(assess_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Calaveras Assessment Collapse.RData")
```
...
# Save file  
save(assess_table, file = "G:/CrimJustice/PretrialAssessmentPilot/Assessment Output Tables/Calaveras Assessment Output 02-2021.RData")
```
...
Collapse
```{r}
# Calaveras Final Collapse
calaveras_collapse <- join_df2 %>%
  ...
  mutate(release_type = ordered(release_type, levels = c("Unknown", "Other", "Sentenced", "Time_Served", "Detain_Only", "Dismissed_Dropped", "OR", "Bail_Bond", "Cite_Release", "Hold_Release"))) %>%
  group_by(book_num) %>%
...
doj_assess <- df[[1]] %>%
  select(cii, fbi, first_name, last_name, dob, cdl_id, race_original, sex_original, local_id) %>%
...
doj_book <- df[[2]] %>%
  select(cii, fbi, first_name, last_name, dob, cdl_id, race_original, sex_original) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
doj_court <- df[[3]] %>%
  select(cii, fbi, cdl_id, dob, race_original, sex_original, first_name, last_name) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
# doj_assess <- doj_assess %>% select(-local_id)
...
#CIIs for DOJ
doj_cii <- bind_rows(doj_assess %>% select(cii), doj_book %>% select(cii), doj_court %>% select(cii)) %>% distinct()
...
write.xlsx(list(doj_cii, doj_assess, doj_book, doj_court), file = "CIIs for DOJ/February 2021/Calaveras P3 CIIs and Demographics for DOJ.xlsx", sheetName = c("ciis", "assess", "booking", "court"))
```
...
book_df_p3_1 <- fread("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Jail Pretrial  July 1 2020-December 31 2020.csv", colClasses = "character")

book_df_p3_2 <- fread("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Jail Pretrial  January 1 2021-January 31 2021.csv", colClasses = "character")

book_df <- book_df %>%
  bind_rows(book_df_p1, book_df_p2, book_df_p3_1, book_df_p3_2) %>%
  distinct()

rm(book_df_p1, book_df_p2, book_df_p3_1, book_df_p3_2)
...
save(book_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Modoc Booking Collapse.RData")
```
...
# Court Cases
court_case <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 1, col_types = "text")
...
# Court Filing Charges
  ## court_charge contains one row per related court case and charge combination, as well as information on each of the charges. Initially, it also duplicated information when a charge had multiple disposition dates. The first date is taken.
court_charge <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 2, col_types = "text")
...
court_sent <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 3, col_types = "text") %>%
  select(-Violation)
...
# Court Hearings
  ## court_hearing contains one row per court_case_id and hearing event.
court_hearing <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 4, col_types = "text")
...
court_person <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 6, col_types = "text")
...
# Court CII Information
  ## court_cii contains one row per person.
court_cii <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 7, col_types = "text")
...
# Court FTAs
  ## court_fta contains one row per FTA event.
court_fta <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 9, col_types = "text")
...
# Court FTAs with Warrants
  ## court_fta_war contains one row per FTA event with a bench warrant issued.
court_fta_war <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/Modoc Pretrial Assessment Information_2015 to 2020_Entire year/Modoc Pretrial Assessment Information_2015 to 2020_Entire year.xls", sheet = 10, col_types = "text")
...
save(court_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Modoc Court Collapse.RData")
```
...
Probation Data
```{r}
assess_df1 <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/PreTrial Data Element and ORAS Questions.xlsx", sheet = 1, col_types = "text") %>%
  select(-(37:40))

assess_df2 <- read_excel("Historical Data Submissions/Modoc/P3 Submission-Jan 15/PreTrial Data Element and ORAS Questions.xlsx", sheet = 2, col_types = "text") %>%
  select(-(27:32))

# Variable name standardization--See pg. xxx for more details.
  ## What is SRNA?
  ## Why does the second one not have pretrial_termination_reason_original?
names(assess_df1) <- c("assessment_date", "name", "dob", "sex_original", "race_original", "zip_code", "cii", "fbi", "local_id", "cdl_id", "dln_state", "cite_date", "court_date", "bail_amt", "risk_level_original", "oras_tool_response_1", "oras_tool_response_2", "oras_tool_response_3", "oras_tool_response_4", "oras_tool_response_5", "oras_tool_response_6", "oras_tool_response_7", "oras_risk_score", "release_recommendation_original", "release_authorization_original", "pretrial_release_type_original", "pretrial_release_date", "pretrial_conditions_original", "pretrial_violation_original", "pretrial_violation_date", "court_date_reminder_original", "other_pretrial_service_original", "srna", "srna_score", "pretrial_termination_reason_original", "notes")

names(assess_df2) <- c("assessment_date", "name", "dob", "sex_original", "race_original", "zip_code", "cii", "fbi", "local_id", "cdl_id", "dln_state", "cite_date", "court_date", "bail_amt", "risk_level_original", "oras_tool_response_1", "oras_tool_response_2", "oras_tool_response_3", "oras_tool_response_4", "oras_tool_response_5", "oras_tool_response_6", "oras_tool_response_7", "oras_risk_score", "release_recommendation_original", "release_authorization_original", "pretrial_release_type_original", "pretrial_conditions_original", "pretrial_violation_original", "pretrial_violation_date", "court_date_reminder_original", "other_pretrial_service_original", "srna", "srna_score", "pretrial_termination_reason_original", "notes")
...
save(assess_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Modoc Assessment Collapse.RData")
```
...
# Save file  
save(assess_table, file = "G:/CrimJustice/PretrialAssessmentPilot/Assessment Output Tables/Modoc Assessment Output 02-2021.RData")
```
...
# Pull CII and other identifiers
doj_assess <- df[[1]] %>%
  select(cii, fbi, dob, cdl_id, race_original, sex_original, local_id) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
doj_court <- df[[3]] %>%
  select(cii, first_name, last_name) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
#Create an excel workbook with all data table. Make sure to include the cii table first. 
write.xlsx(list(doj_cii, doj_assess, doj_book, doj_court), file = "CIIs for DOJ/February 2021/Modoc P3 CIIs and Demographics for DOJ.xlsx", sheetName = c("ciis", "assess", "booking", "court"))
```
...
save(book_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/San Joaquin Booking Collapse.RData")
```
...
save(court_df2, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/San Joaquin Court Collapse.RData")
```
...
# Variable name standardization--See pg. xxx for more details.
names(assess_df) <- c("count", "assessment_date", "unknown_id", "court_docket_id", "book_num", "assessment_charge", "last_name", "first_name", "cii", "local_id", "dln_state", "cdl_id", "dob", "sex_original", "race_original", "zipcode", "vprai_risk_score_original", "transdermal_study", "override", "auto_hold_1270.1", "auto_hold_1319", "auto_hold_other", "release_authorization_prearraignment", "release_authorization_postarraignment", "concurrence", "judge_name", "gps", "pretrial_release_date", "pretrial_monitor_start_date", "pretrial_monitor_end_date", "monitor_level_original", "fta_warrant", "court_remand", "remand_date", "remand_memo", "rearrest", "rearrest_date", "rearrest_charge", "charge_description", "assessment_charge_level", "termination_outcome", "notes")
...
save(assess_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/San Joaquin Assessment Collapse.RData")
```
...
assess_table <- assess_df %>%
  # Collapse to each assessment.
  distinct(local_id, last_name, first_name, assessment_date, .keep_all = T) %>%
  # Filter for only those actually assessed
  filter(!is.na(assessment_date)) %>%
  # Create county name.
...
# Save file  
save(assess_table, file = "G:/CrimJustice/PretrialAssessmentPilot/Assessment Output Tables/San Joaquin Assessment Output 02-2021.RData")
```
...
# Pull CII and other identifiers
doj_assess <- df[[1]] %>%
  select(cii, first_name, last_name, dob, cdl_id, race_original, sex_original, local_id) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
doj_book <- df[[2]] %>%
  select(cii, cdl_id, dob, race_original, sex_original, first_name, last_name, local_id) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
#CIIs for DOJ
doj_cii <- bind_rows(doj_assess %>% select(cii), doj_book %>% select(cii)) %>% distinct()
...
#Create an excel workbook with all data table. Make sure to include the cii table first. 
write.xlsx(list(doj_cii, doj_assess, doj_book), file = "CIIs for DOJ/February 2021/San Joaquin P3 CIIs and Demographics for DOJ.xlsx", sheetName = c("ciis", "assess", "booking"))
```
...
save(book_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Ventura Booking Collapse.RData")
```
...
save(court_df2, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Ventura Court Collapse.RData")
```
...
save(assess_df, file = "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Ventura Assessment Collapse.RData")
```
...
# Save file  
save(assess_table, file = "G:/CrimJustice/PretrialAssessmentPilot/Assessment Output Tables/Ventura Assessment Output 02-2021.RData")
```
...
doj_book <- df[[2]] %>%
  select(cii, fbi, cdl_id, race_original, sex_original, local_id) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
doj_court <- df[[3]] %>%
  select(cii, fbi, cdl_id, dob, race_original, sex_original, first_name, last_name, local_id) %>%
  mutate(cii = parse_number(cii),
         cii = case_when(nchar(cii) == 6 ~ paste0("0000", cii),
                         nchar(cii) == 7 ~ paste0("000", cii),
                         nchar(cii) == 8 ~ paste0("00", cii),
...
#Create an excel workbook with all data table. Make sure to include the cii table first. 
write.xlsx(list(doj_cii, doj_assess, doj_book, doj_court), file = "CIIs for DOJ/February 2021/Ventura P3 CIIs and Demographics for DOJ.xlsx", sheetName = c("ciis", "assess", "booking", "court"))
```
