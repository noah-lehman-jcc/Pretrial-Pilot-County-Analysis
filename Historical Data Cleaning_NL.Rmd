...
# Jail Bookings Data Import--- Los Angeles, 2015-01-01 to 2020-01-06
  ## book_df contains one row per booking and includes information on the person as well as the time of booking and release. It contains no charge information.
  ## Next time we need to simplify bookings to charges per booking and separately create a reference frame for court cases attached to each booking. Currently, all charges on a booking are associated with all court cases. This is incorrectr. 
