...
# Save Snowflake extract to push to secure server
```{r}
#save(sf, file = "C:/TEMP/Snowflake extract for joining 6.27.22.RData")
save(sf, file = "C:/TEMP/Snowflake extract for joining 8.25.23.RData")
```
...
```{r}
load("Final Failure Evaluation2 2023.Rdata")
```
...
rename(pretrial_period_end_date_doj = pretrial_end_date_DOJ) %>%
...
fwrite(test_doj, file="G:/CrimJustice/PretrialAssessmentPilot/ADLS Load/final_doj_for_upload to sf 6.27.23.csv")
save(test_doj, file = "G:/CrimJustice/PretrialAssessmentPilot/ADLS Load/final_doj_for_upload to sf 6.27.23.RData")
