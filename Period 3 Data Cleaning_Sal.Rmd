...
prob_df <- read_excel("Historical Data Submissions/Napa/P3 Submission-Jan 15/Historical_12-31-2020_ProbData_1.xlsx", sheet = 5, col_types = "text")
...
#   distinct()
prob_bookings <- read_excel("Historical Data Submissions/Napa/P3 Submission-Jan 15/Historical_12-31-2020_ProbData_1.xlsx", sheet = 1, col_types = "text") %>%
  distinct()

# Variable name standardization--See pg. xxx for more details. 
names(prob_bookings) <- c("local_id", "book_num", "assessment_id", "no_assessment_reason", "book_date_time", "excluded")
...
names_df <- tibble(original_field = names(prob_df)) 
