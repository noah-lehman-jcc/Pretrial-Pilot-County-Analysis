...
person_df <- bind_rows(person_df, person_df2) %>%
  distinct()
...
# Variable name standardization--See pg. xxx for more details. 
names(book_df) <- c("book_num", "court_case_id", "local_id", "book_type_original", "book_date", "release_date", "release_type_original", "arrest_date")
