...
#fwrite(book_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Kings Booking Collapse.csv")
```
...
#fwrite(court_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Kings Court Collapse.csv")
...
#fwrite(assess_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Kings Assessment Collapse.csv")
...
person_df <- read_excel("Historical Data Submissions/Napa/P3 Submission-Jan 15/Historical_12-31-2020_1.xlsx", sheet = 1) %>%
...
#fwrite(book_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Napa Booking Collapse.csv")
```
...
#fwrite(court_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Napa Court Collapse.csv")
```
...
prob_reports <- read_excel("Historical Data Submissions/Napa/P3 Submission-Jan 15/Historical_12-31-2020_ProbData_3.xlsx", sheet = 2)
...
prob_case <- read_excel("Historical Data Submissions/Napa/P3 Submission-Jan 15/Historical_12-31-2020_ProbData_3.xlsx", sheet = 3)
...
prob_cond <- read_excel("Historical Data Submissions/Napa/P3 Submission-Jan 15/Historical_12-31-2020_ProbData_3.xlsx", sheet = 4)
...
#fwrite(assess_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Napa Assessment Collapse.csv")
# assess_df %>%
#   filter(!is.na(assessment_date))
#   distinct(pretrial_id)
#   
...
#fwrite(book_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Sacramento Booking Collapse.csv")
...
#fwrite(court_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Sacramento Court Collapse.csv")
...
#fwrite(assess_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Sacramento Assessment Collapse.csv")
```
...
names(book_df) <- c("lent_key", "book_num", "book_date_time", "arrest_date_time",  "book_type_original", "booked_or_pending_charge", "ccas_key", "court_case_id", "court_docket_id", "arrest_charge_code_original", "arrest_charge_original", "arrest_charge_level_original", "arrest_charge_description", "arrest_charge_counts",  "bail_amt")
...
names(book_case) <- c(  "book_num", "lent_key","book_date_time",  "book_type_original", "release_date_time", "release_type_original", "release_info", "bail_amt", "employment_status_employer", "employment_type")
...
#fwrite(book_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Sonoma Booking Collapse.csv")
...
court_cases <- fread("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/NonPTR_Cases.csv") 


# Variable name standardization--See pg. xxx for more details. 
names(court_cases) <- c("court_case_id", "court_docket_id", "party_id", "name", "file_date", "ra_referal", "ra_report", "trash")
#names(court_cases2) <- c("court_case_id", "court_docket_id", "party_id", "name", "file_date", "ra_referal", "ra_report", "trash")


#remove blank trash field
...
#fwrite(court_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Sonoma Court Collapse.csv")
...
prob_assess1 <- read.csv("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/ProbationDataset1_AssessmentsAndGrants.csv", stringsAsFactors = FALSE)
prob_assess2 <- read.csv("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/ProbationDataset2_SPRATassessments.csv", stringsAsFactors = FALSE)
prob_assess3 <- read.csv("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/ProbationDataset3_PSAassessments.csv", stringsAsFactors = FALSE)
prob_assess4 <- read.csv("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/ProbationDataset4_Individuals.csv", stringsAsFactors = FALSE)
prob_assess5 <- read.csv("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/ProbationDataset5_PretrialViolations.csv", stringsAsFactors = FALSE)
prob_assess6 <- read.csv("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/ProbationDataset6_TermsandConditions.csv", stringsAsFactors = FALSE)
prob_assess7 <- read.csv("Historical Data Submissions/Sonoma/P3 Submission-Jan 15/ProbationDataset7_CourtDateReminders.csv", stringsAsFactors = FALSE)
...
#fwrite(assess_df, "G:/CrimJustice/PretrialAssessmentPilot/Agency Collapse CSV Files/Sonoma Assessment Collapse.csv")
