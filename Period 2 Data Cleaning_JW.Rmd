...
# About 7,000 bookings do not have a court docket ID and may match. Look more into this later.
# j1 <- book_df %>%
#   anti_join(court_df, by = "court_docket_id")
# 
# c1 <- court_df %>%
#   anti_join(book_df, by = "court_docket_id")
# 
# j1 %>%
#   mutate(ipid = as.character(ipid)) %>%
#   filter(court_docket_id == "") %>%
#   semi_join(c1, by = "ipid")
# 
# court_df %>%
#   filter(grepl("CR-2014-156..", court_docket_id))
...
# Start here. Collapse to pretrial period.
```
