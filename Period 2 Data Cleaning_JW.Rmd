...
court_fta_war <- read_excel("Historical Data Submissions/Calaveras/P2 Submission-June 30/ODY-330217 CACALAVERASPROD - JCC Pretrial Data Extract Script Request.xlsx", sheet = 3, col_types = "text")
...
court_sent <- read_excel("Historical Data Submissions/Calaveras/P2 Submission-June 30/ODY-330217 CACALAVERASPROD - JCC Pretrial Data Extract Script Request.xlsx", sheet = 2, col_types = "text")
