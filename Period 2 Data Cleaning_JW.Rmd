...
assess_df <- fread("Historical Data Submissions/Calaveras/P2 Submission-June 30/1920 Q4 Probation_Pretrial.csv", colClasses = "character")
...
#   ## Use period 2 data to replace historical data submission and period 1 data.
# assess_df <- fread("Historical Data Submissions/San Joaquin/P2 Submission-June 30/Court/pretrial assessment reports.csv", colClasses = "character")
# 
# # Variable name standardization--See pg. xxx for more details.
...
assess_df <- read_excel("Historical Data Submissions/San Joaquin/P2 Submission-June 30/Pretrial Data.xlsx", col_types = "text")
...
```{r}
assess_df <- read_excel("Historical Data Submissions/Ventura/Pretrial Supervision - VCPA.xlsx") %>%
...
assess_df_p1 <- lapply(1:6, function(i) {
  if (i == 1)
...
assess_df_p1 <- assess_df_p1[c(1, 3:6)] %>%
  reduce(left_join) %>%
  left_join(assess_df_p1[[2]], by = c("ScreeningID", "Local_ID")) %>%
...
assess_df <- read_xlsx("Historical Data Submissions/Ventura/P2 Submission-June 30/Pretrial 2020Q2 Data Report - VCPA.xlsx", sheet = 1, col_types = "text", skip = 1) %>%
  # empty column
  select(-26) %>%
  # duplicate headers
  slice(-1)

names_df1 <- tibble(original_field = names(assess_df))
...
names_df1$field <- names(assess_df)
...
assess_response <- read_xlsx("Historical Data Submissions/Ventura/P2 Submission-June 30/Pretrial 2020Q2 Data Report - VCPA.xlsx", sheet = 2, col_types = "text")
...
assess_condition <- read_xlsx("Historical Data Submissions/Ventura/P2 Submission-June 30/Pretrial 2020Q2 Data Report - VCPA.xlsx", sheet = 3, col_types = "text")

names_df2 <- tibble(original_field = names(assess_condition))

# Variable name standardization--See pg. xxx for more details.
names(assess_condition) <- c("assessment_id", "local_id", "court_case_id", "release_conditions_original")

names_df2$field <- names(assess_condition)
...
assess_service <- read_xlsx("Historical Data Submissions/Ventura/P2 Submission-June 30/Pretrial 2020Q2 Data Report - VCPA.xlsx", sheet = 5, col_types = "text")

names_df3 <- tibble(original_field = names(assess_service))

# Variable name standardization--See pg. xxx for more details.
names(assess_service) <- c("assessment_id", "local_id", "other_pretrial_service_original")

names_df3$field <- names(assess_service)
...
assess_violation <- read_xlsx("Historical Data Submissions/Ventura/P2 Submission-June 30/Pretrial 2020Q2 Data Report - VCPA.xlsx", sheet = 4, col_types = "text")

names_df4 <- tibble(original_field = names(assess_violation))

# Variable name standardization--See pg. xxx for more details.
names(assess_violation) <- c("assessment_id", "local_id", "pretrial_violation_original", "pretrial_violation_date")

names_df4$field <- names(assess_violation)
...
assess_court_match <- read_xlsx("Historical Data Submissions/Ventura/P2 Submission-June 30/Pretrial 2020Q2 Data Report - VCPA.xlsx", sheet = 6, col_types = "text")
