...
lapply(c("Los Angeles", "Sacramento", "Ventura", "Sonoma", "Tulare", "San Joaquin", "Napa", "Alameda", "San Mateo", "Santa Barbara"),
  function(x){
...
Calaveras  - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, fig.height=7, fig.widith=, include=FALSE}
risk_df <- race_df %>%
  filter(tool_name == "PSA", county == "Calaveras") %>%
  group_by(race, psa_fta_risk_score) %>%
  summarise(across(c(fta_flag),
