...
kable(date_df, booktabs = T, format.args = list(big.mark = ","), 
    ...
    kable_styling(position = "center", full_width = F, 
                  bootstrap_options = c("striped", "hover"), stripe_color = "gray", font_size = 14, latex_options = "hold_position")# %>%
 # save_kable(file = "C:/Pretrial-Pilot-County-Analysis/date_range.tex")

#tinytex::pdflatex('C:/Pretrial-Pilot-County-Analysis/date_range.tex')

#latexmk('C:/Pretrial-Pilot-County-Analysis/date_range.tex')
...
# Ventura removed temporarily

lapply(c("Los Angeles", "Sacramento", "Sonoma", "Tulare", "San Joaquin", "Napa", "Alameda", "San Mateo", "Santa Barbara"),
  function(x){
...
Ventura -- White and Hispanic only - temporarily removed
\newline
```{r eval=FALSE, fig.height=6, fig.width=10, dpi=1200, include=FALSE}
risk_df <- eval_df %>%
  mutate(race = factor(race, levels = c("White", "Black", "Hispanic", "Other_Unknown"))) %>%
...
Ventura--Without Interactions - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
...
Ventura--With Interactions at lowest score 0 - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
...
Ventura--With Interactions at score 9 - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
...
Ventura--Without Interactions  -- White and Hispanic only  - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
...
Ventura--With Interactions at lowest score 0 -- White and Hispanic only - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
...
Ventura--With Interactions at score 9 -- White and Hispanic only - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
...
Ventura -- only White and Hispanic - TEMPORARILY REMOVED
\newline
```{r eval=FALSE, include=FALSE}
tool_df <- auc_df %>%
...
Ventura--With Interactions - temporarily removed
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
...
Ventura ORAS AUC race comparisons - TEMPORARILY REMOVED
```{r eval=FALSE, include=FALSE}
...
Ventura ORAS AUC gender comparisons - TEMPORARILY REMOVED
```{r eval=FALSE, include=FALSE}
...
Ventura -- Arrest offense - temporarily removed
\newline
```{r eval=FALSE, fig.height=6, fig.width=10, dpi=1200, include=FALSE}
risk_df <- eval_df %>%
  mutate(arrest_cat = case_when(arrest_dv_flag == 1 ~ "DV",
