...
```{sql eval=FALSE, connection=con, include=FALSE, echo=TRUE, output.var='df'}
SELECT *
...
```{sql eval=FALSE, connection=con, include=FALSE, echo=TRUE, output.var='join_df'}
SELECT *
...
```{sql eval=FALSE, connection=con, include=FALSE, echo=TRUE, output.var='addon_df'}
