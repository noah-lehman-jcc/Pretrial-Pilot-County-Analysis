...
Pull snowflake data -- cjs_outcome_std -- removed
...
Format data - full df and eval df -- removed
...
lapply(c("Los Angeles", "Sacramento", "Ventura", "Sonoma", "Tulare", "San Joaquin", "Modoc", "Napa", "Calaveras", "Alameda", "Santa Barbara"),
  function(x){
