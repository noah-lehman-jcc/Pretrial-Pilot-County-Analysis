...
df <- df %>%
  ...
  filter(assessment_date >= as.Date("2019-10-01"),
         assessment_date < as.Date("2022-01-01")) %>%
...
Tulare--Without Interactions -- temporarily removed
\newline
...
Tulare--Without Interactions, White and Hispanic only -- temporarily removed
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
county_df <- race_df %>%
  filter(race != "Black") %>%
...
Tulare--With Interactions -- temporarily removed 
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
county_df <- race_df %>%
  filter(county == "Tulare") %>%
...
Tulare--With Interactions, White and Hispanic only -- temporarily removed
\newline
```{r eval=FALSE, include=FALSE, results='asis'}
county_df <- race_df %>%
  filter(county == "Tulare") %>%
...
Tulare -- only White & Hispanic -- temporarily removed
\newline
```{r eval=FALSE, include=FALSE}
tool_df <- auc_df %>%
