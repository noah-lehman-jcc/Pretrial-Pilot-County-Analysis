...
cii_df <- read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Alameda/P3 Submission-Jan 15/2.5.21/IdentifiersAndDemographicsBookings07012016to12312020.xlsx")  
...
save(book_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Los Angeles Booking Collapse.RData")
```
...
save(court_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Los Angeles Court Collapse.RData")
```
...
save(assess_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Los Angeles Assessment Collapse.RData")
```
...
# Save file  
save(assess_table, file = "C:/Work/PretrialAssessmentPilot/Assessment Output Tables/Los Angeles Assessment Output 02-2021.RData")
...
save(book_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Santa Barbara Booking Collapse.RData")
```
...
save(court_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Santa Barbara Court Collapse.RData")
```
...
save(assess_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Santa Barbara Assessment Collapse.RData")
```
...
# Save file  
save(assess_table, file = "C:/Work/PretrialAssessmentPilot/Assessment Output Tables/Santa Barbara Assessment Output 10-2020.RData")
...
#Create an excel workbook with all data table. Make sure to include the cii table first. 
write.xlsx(list(doj_cii, court_df), file = "CIIs for DOJ/February 2021/Tulare P3 CIIs and Demographics for DOJ.xlsx", sheetName = c("ciis", "court"))
...
# fwrite(jail_df, file = "C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tuolumne/Tuolumne Jail xml to csv Period 3.csv")
...
book_df <- fread("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tuolumne/Tuolumne Jail xml to csv Period 3.csv")
...
save(book_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Tuolumne Booking Collapse.RData")
```
...
save(court_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Tuolumne Court Collapse.RData")
...
# Fix Names Later
assess_df2 <- read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tuolumne/P3 Submission-Jan 15/6.30.20-12.31.20 Pretrial Spreadsheet.xlsx", col_types = "text")
...
assess_response <- read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tuolumne/P3 Submission-Jan 15/PSAs 6.30.20-12.31.20.xls", col_types = "text", skip = 1)
