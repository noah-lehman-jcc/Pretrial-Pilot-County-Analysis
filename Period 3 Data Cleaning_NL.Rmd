...
assess_dfq2 <- fread("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Los Angeles/P3 Submission-Jan 15/ISAB_PsaHistoricalExtract_20210114.csv",
                  sep = "|", colClasses = "character")
...
assess_df2 <- read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Los Angeles/P3 Submission-Jan 15/Los Angeles County Pretrial Services Bureau - JCC Court Pilot Data (2020-01-01 to 2020-12-31).xlsx", sheet = 3, col_types = "text")

names(assess_df2) <- toupper(names(assess_df2))

assess_df2_response <- read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Los Angeles/P3 Submission-Jan 15/Los Angeles County Pretrial Services Bureau - JCC Court Pilot Data (2020-01-01 to 2020-12-31).xlsx", sheet = 4, col_types = "text")
...
book_df4 <- read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/P3 Submission-Jan 15/SB.Jail.Data.Jul.Dec.20.xlsx", col_types = "text")
...
court_df <- lapply(1:6, function(i){
  read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tulare/P3 Submission-Jan 15/TCSC Case Filings.xlsx", col_types = "text", sheet = i, col_names = F)
}) %>% bind_rows()
...
#Standardize Names
names(court_df) <- c("court_case_id", "filing_date", "case_status", "case_status_date", "name", "dob", "sex_original", "race_original", "fbi", "cii", "cdl_id",  "court_charge_level_original", "court_charge_original", "court_charge_description", "disposition_date", "disposition_type_original", "sentence_date", "sentence_type_original","sentence_term", "service_location", "final_disposition_date")
...
court_hearing <- lapply(1:3, function(i){
  read_excel("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tulare/P3 Submission-Jan 15/TCSC Hearings.xlsx", col_types = "text", sheet = i, col_names = F)
}) %>% bind_rows()
...
court_hearing %>%
  # semi_join(court_df) %>%
  count(year(hearing_date_time))o
