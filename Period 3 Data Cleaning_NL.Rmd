...
save(book_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Alameda Booking Collapse.RData")
```
...
save(court_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Alameda Court Collapse.RData")
```
...
assess_df <- assess_df %>%
  ...
  mutate(vprair_risk_score = sum(c_across(vprair_tool_response_1:vprair_tool_response_8), na.rm = T),
         vprair_risk_score = if_else(vprair_risk_score == 0, NA_real_, vprair_risk_score))
  

save(assess_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Alameda Assessment Collapse.RData")
```
...
# Save file  
save(assess_table, file = "C:/Work/PretrialAssessmentPilot/Assessment Output Tables/Alameda Assessment Output 10-2020.RData")
...
```{r}
#Jail Data
# doc <- read_xml("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tulare/P3 Submission-Jan 15/10_01_2020-02_01_2021.xml")
# doc_list <- lapply(
...
# 
# 
# fwrite(jail_df, file = "C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tulare/P3 Submission-Jan 15/Tulare Jail xml to csv 2-18-2021.csv")
...
book_df <- fread("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tulare/P3 Submission-Jan 15/Tulare Jail xml to csv 2-18-2021.csv",
...
save(assess_df, file = "C:/Work/PretrialAssessmentPilot/Agency Collapse CSV Files/Tuolumne Assessment Collapse.RData")
```
...
# Save file  
save(assess_table, file = "C:/Work/PretrialAssessmentPilot/Assessment Output Tables/Tuolumne Assessment Output 02-2021.RData")
