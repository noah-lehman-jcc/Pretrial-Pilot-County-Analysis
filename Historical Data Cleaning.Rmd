...
book_df <- lapply(1:4, function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/BOOK_", i, ".csv"),
...
book_charge <- lapply(1:2, function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/ARRCHG_", i, ".csv"),
        colClasses = "character")}) %>%
  bind_rows()
...
court_df <- lapply(c("", "_2"), function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/CASE", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
court_fta <- lapply(c("", "_2"), function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/FTA", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
court_fta_war <- lapply(c("", "_2"), function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/WARR", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
court_hearing <- lapply(1:8, function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/HEA_", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
court_charge <- lapply(1:8, function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/CHG_", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
court_sent <- lapply(c("", "_2"), function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/JAIL", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
court_sup <- lapply(c("", "_2"), function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/SUP", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
Jail Data
```{r}
book_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Calaveras/JailData.xlsx")
...
Probation Data
```{r}
prob_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Calaveras/ProbationData.xlsx", col_types = "text")
...
```{r}
book_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Kings/Pretrial Pilot Program-2015.csv")
book_df2 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Kings/Pretrial Pilot Program-2016.csv")
book_df3 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Kings/Pretrial Pilot Program-2017.csv")
book_df4 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Kings/Pretrial Pilot Program-2018.csv")
book_df5 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Kings/Pretrial Pilot Program-2019.csv")
...
book_df <- lapply(2015:2019, function(i){
  read_xlsx(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Los Angeles/",i, ".xlsx"))}) %>%
  bind_rows()
...
# Jail Booking Charges
book_charge <- lapply(1:2, function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Alameda/ARRCHG_", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
prob_response <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Los Angeles/California JCC Historical EM Records (Revised 2019-11-25).xlsx", 
                      sheet = 2)
...
prob_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Los Angeles/California JCC Historical EM Records (Revised 2019-11-25).xlsx", 
                      sheet = 1)
...
```{r}
#Booking data
book_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Jail Pretrial  January 1 2013-November 30 2019.csv")
...
Court Data 
```{r}
court_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 1)

names(court_df) <- c("case_id", "name", "disposition_type", "disposition_date", "filing_date", "case_type")

court_charge <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 2)
...
court_sent <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 3)
...
court_hearing <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 4)

names(court_hearing) <- c("case_id", "hearing_type", "hearing_date", "hearing_time", "hearing_result")

court_lawyer <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 5)

names(court_lawyer) <- c("case_id", "lawyer_type", "appointment_date", "appointment_status", "appointment_end_date")

court_person <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 6)

names(court_person) <- c("first_name", "last_name", "dob", "sex", "race", "cii", "fbi", "arrest_num", "book_num")

court_bail <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 7)

names(court_bail) <- c("case_id", "release_type", "release_date", "bail_status", "bail_status_date")

court_fta <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 8)

names(court_fta) <- c("case_id", "fta_date", "fta")

court_fta_war <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Modoc/Modoc Pretrial Assessment Information.xls", sheet = 9)
...
person_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 1)
...
#Jail Booking Events 
book_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 2, col_types = "text")
...
```{r}
#Filing Dates
da_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 3)
...
#Da Charges
da_charge <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 4)
...
```{r}
#Court Data on FTAs
court_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 5)
...
#Court Charges
court_charge <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 6)
...
#Court FTA Warrants
court_fta_war <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 7)
...
#Court FTAs
court_fta <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Historical_1.xlsx", sheet = 8)
...
Assessment Data
```{r}
prob_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Napa/Assessment_Historical.xlsx")
...
Jail Data
```{r}
book_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Nevada/SO Pretrial Submitted Data.xlsx")
...
prob_df <- lapply(c("2016.", "2017.", "2018. "), function(i){
  lapply(getSheetNames(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Nevada/PRETRIAL STATS ", i, "Nevada.xlsx")), function(j){
    read_excel(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Nevada/PRETRIAL STATS ", i, "Nevada.xlsx"), 
...
# Jail Bookings
book_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacBookingDetail.csv")
...
#Booking Dates
book_date <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacBookingMain.csv")
...
#Jail Bail Amounts
book_bail <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacBail.csv")
...
```{r}
#High level casees
court_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacCases.csv")
...
#Court Hearing Data
court_hearing <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacAppear.csv")
...
court_dispos <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacDispos.csv")
...
#Court person ids
court_person <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacPersonDetail.csv")
...
#Court Warrants
court_warrants <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sacramento/SacWarrants.csv")
...
Jail Data
```{r}
book_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/Jail_ATIMS_Data_BOOKING_20150101_to_20190930_3.csv")

names(book_df) <- c("book_num", "lar", "case_id", "bail_amt", "arrest_date", "book_date", "book_type", 
                    "release_date", "release_type")

book_charge <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/Jail_ATIMS_Data_CHARGES_20150101_to_20190930_3.csv")

names(book_charge) <- c("book_num", "count", "charge_code", "charge", "charge_description", "charge_level")

book_demo <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/Jail_ATIMS_Data_PARTY_20150101_to_20190930_3.csv")

names(book_demo) <- c("lar", "cii", "first_name", "last_name", "dln", "dln_state", "dob", "sex", "race")

book_ipid <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/Jail_ATIMS_Data_LAR_to_IPID_20150101_to_20190930_3.csv")
...
```{r}
#High level casees
court_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial case.csv")
...
court_charge <- lapply(1:4, function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial charge ", i, ".csv"), colClasses = "character")}) %>%
  bind_rows()
...
court_hearing <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial hearing.csv")

names(court_hearing) <- c("case_id", "case_type", "hearing_date", "hearing_type")

court_person <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial party.csv")

names(court_person) <- c("ipid", "court_id", "last_name", "first_name", "dob", "gender", "race", "ethnicity", "dln", "dln_state")

court_fta <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial FTA by hearing.csv")

names(court_fta) <- c("case_id", "case_type", "hearing_date", "hearing_type")

court_fta_warrant <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial FTA by warrant.csv")
...
DA data 
```{r}
da_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial booking.csv")

namea(da_df) <- c("ipid", "fce_entity_id", "case_id", "case_id_full", "da_complaint_num", "book_num")

prob_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/pretrial assessment report.csv")
...
```{r}
read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Joaquin/MASTER Pretrial Data Collection Variables 2011.xlsx")
```
...
book_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-SO-01OF01-JAN2015-JUN2019.csv", colClasses = "text")
book_df2 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-SO-01OF02-JUL2019-SEPT2019.csv", colClasses = "text", header = F)
...
```{r}
#High level cases
court_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-COURT-01OF03-JAN2016-SEP2019.csv")
...
#Sentence Data
court_sentence <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-COURT-02OF03-JAN2016-SEP2019.csv")
...
```{r}
# prob_df1 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-PROBATION-01OF04-JAN2015-SEP2019.csv")
# prob_df2 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-PROBATION-02OF04-JAN2015-SEP2019.csv")
# prob_df3 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-PROBATION-03OF04-JAN2015-SEP2019.csv")
# prob_df4 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-PROBATION-04OF04-JAN2015-SEP2019.csv")
```
...
Jail Data
```{r}
book_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Jail.Data.12.5.xlsx", col_types = "text")
...
```{r}
#Court Status
court_status <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/CaseStatus.csv", header = F)

names(court_status) <- c("case_id", "case_num", "status_date", "status")

#Court Charges
court_charges <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Charges.csv", header = F)
...
#Court hearing data
court_hearing <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Hearings.csv", header = F)
...
court_confinement <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/SentConf.csv")
...
court_probation <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/SentProb.csv", header = F)

names(court_probation) <- c("case_id", "case_num", "sentence_date", "setence_type", "sentence_loc",
                              "sentence_term", "term_length")

#Court Person IDs
court_person <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/TechElements.csv", header = F)
...
#FTA Warrants
court_fta_war <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Warrants.csv", header = F)
...
assess_interview <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Full.xlsm", skip = 1)
...
assess_tracking <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Full.xlsm", skip = 1, sheet = 3)
...
assess_outcome <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Full.xlsm", skip = 1, sheet = 4)
...
assess_nointerview <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Santa Barbara/Non.xlsm", skip = 1)
...
Jail Data
```{r}
book_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tulare/JMS data.csv", sep = NULL, col.names = "x")
...
court_df <- lapply(c("15-16", "16-17", "17-18", "18-19"), function(i){
  fread(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tulare/PretrialStatsFY", i, ".csv"), colClasses = "character", header = F)}) %>%
  bind_rows()
...
```{r}
prob_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tulare/Extremely Rough DRAFT Pretrial Project data 20191008 1722.csv")
...
Court Data
```{r}
court_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 1)

court_charges <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 2)

court_sentence <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 3)

court_hearing <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 4)
court_hearing2 <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 5)

court_hearing <- bind_rows(court_hearing, court_hearing2)
rm(court_hearing2)

court_lawyer <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 6)

court_demo <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 7)

court_demo2 <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne Pretrial Assessment Information.xls", sheet = 8)
```

Probation (assessment)--Confusing Data. Figure out later. 
```{r}
# prob_df <- lapply(2018:2019, function(i){
#   lapply(getSheetNames(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne County Probation Pre-Trial Data ", i, ".xlsx")),
#          function(j){
#     df <- read_excel(paste0("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Tuolomne/Tuolumne County Probation Pre-Trial Data ", i, ".xlsx"),
...
Jail Data
```{r}
book_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Ventura/jcc_ptm_vcsh_2015_2019.xlsx")
...
Court Data
```{r}
court_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Ventura/jcc_ptm_vcct_2015_2019.xlsx")
...
Probation (assessment)--Confusing Data. Figure out later. 
```{r}
prob_df <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Ventura/Pretrial Supervision - VCPA.xlsx")
...
Jail Data
```{r}
book_df <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Yuba/JailExtract.csv")
