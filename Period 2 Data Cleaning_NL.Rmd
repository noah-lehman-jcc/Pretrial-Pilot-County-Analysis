...
files <- list.files("C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Alameda/P2 Submission-June 30/", full.names = T)
...
#Create an excel workbook with all data table. Make sure to include the cii table first. 
write.xlsx(list(doj_cii, doj_book, doj_court), file = "CIIs for DOJ/Santa Barbara/P2 Submission-June 30 CIIs and Demographics for DOJ.xlsx", sheetName = c("ciis", "booking", "court"))
```
...
book_df <- book_df %>%
  mutate(sex = case_when(sex_original %in% c("M") ~ "Male",
         ...
         book_type = case_when(book_type_original %in% c("FRESH", "1170(H) VIOL") ~ "On_View",
                               ...
                               T ~ "Other"))
jail_df
summary(ymd_hm(jail_df$BookingDateTime))
```
