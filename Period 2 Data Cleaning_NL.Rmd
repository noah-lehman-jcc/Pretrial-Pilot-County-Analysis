...
assess_table <- assess_df %>%
  ...
  # Select relevants variables.
  select(county, risk_level, assessment_date, 
         local_risk_score, tool_name, assessment_date, dob, sex, race)

# Save file  
fwrite(assess_table, file = "C:/Work/PretrialAssessmentPilot/Assessment Output Tables/Tuolumne Assessment Output 09-2020.csv")
