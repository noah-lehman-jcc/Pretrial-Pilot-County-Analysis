...
assess_table <- assess_df %>%
  ...
  # Select relevants variables.
  select(county, risk_level, release_recommendation, release_decision, assessment_date, vprai_risk_score, vprair_risk_score, tool_name)
...
doc <- read_xml("Historical Data Submissions/Tulare/P2 Submission-June 30/JMS20150101_20200630.xml")
...
fwrite(jail_df, file = "C:/Work/PretrialAssessmentPilot/Historical Data Submissions/Tuolumne/Tulare Jail xml to csv.csv")
