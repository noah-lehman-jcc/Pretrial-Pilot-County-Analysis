...
drop_df2 <- drop_df %>%
  # count(`Tool Name`)
  filter(!`Tool Name` %in% c("CCAT")) %>%
  mutate(`Validation Type` = case_when(`Released Pretrial` >= 1000 ~ "General + Bias",
                                       `Released Pretrial` >= 200 ~ "General Only",
                                       `Released Pretrial` < 200 ~ "Sample Too Small")) %>%
...
kable(drop_df2 , booktabs = T, format.args = list(big.mark = ","), 
        # table.attr = "style = \"color: black;\"",
        format = "latex") %>%
    kable_styling(position = "center", full_width = F, 
...
kable(drop_df, booktabs = T, format.args = list(big.mark = ","), 
        ...
        format = "latex") %>%
  kable_styling(position = "center", full_width = F, 
                  bootstrap_options = c("striped", "hover"), stripe_color = "gray", font_size = 11, 
                  latex_options = "hold_position") 
...
m6 <- glm(family = binomial(),any_pretrial_failure_flag ~ vprai_risk_score + release_to_pretrial_end , data = eval_df)
...
m6 <- glm(family = binomial(),any_pretrial_failure_flag ~ vprair_risk_score + release_to_pretrial_end , data = eval_df)
...
m6 <- glm(family = binomial(),any_pretrial_failure_flag ~ oras_risk_score + release_to_pretrial_end , data = eval_df)
...
ggplot(risk_df %>% distinct(oras_risk_score, Total, race) %>% 
         group_by(race) %>% 
         mutate(percent = round(Total/sum(Total)*100)) %>% ungroup()) +
  aes(x = as.factor(oras_risk_score), y = Total, fill = race) +
  geom_col(position = "dodge") +
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by ORAS Risk Category", fill = "Race")
```
\newpage
...
ggplot(risk_df %>% distinct(vprai_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by VPRAI Risk Category", fill = "Race")    
...
ggplot(risk_df %>% distinct(vprair_risk_score, Total) %>% 
  ...
  theme_bw() +
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by VPRAIR Risk Category", fill = "Race")  
```
\newpage
...
ggplot(risk_df %>%
  ...
  geom_col(position = "dodge") +
  geom_text(vjust = .4, aes(label = str_c( formatC(Total, big.mark = ","), "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by PSA Risk Category", fill = "Race") +
...
ggplot(risk_df %>% distinct(vprair_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Alameda Distribution of Assessments by VPRAIR Risk Category", fill = "Race")  
```
\newpage
...
ggplot(risk_df %>%
  ...
  # ylim(0,100) +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Los Angeles Distribution of Assessments by PSA Risk Category", fill = "Race") +
  scale_y_continuous(expand = expansion(mult = c(.1, .15)))
```
\newpage
...
ggplot(risk_df %>%
  ...
  theme_bw() +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Sacramento Distribution of Assessments by PSA Risk Category", fill = "Race") +
  scale_y_continuous(expand = expansion(mult = c(.1, .15))) 
```
\newpage
...
ggplot(risk_df %>% distinct(vprai_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "San Joaquin Distribution of Assessments by VPRAI Risk Category", fill = "Race")    
```
\newpage
...
ggplot(risk_df %>% distinct(vprair_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Santa Barbara Distribution of Assessments by VPRAIR Risk Category", fill = "Race")  
```
\newpage
...
ggplot(risk_df %>%
  ...
  # ylim(0,100) +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Sonoma Distribution of Assessments by PSA Risk Category", fill = "Race") +
  scale_y_continuous(expand = expansion(mult = c(.1, .15)))
```
\newpage
...
ggplot(risk_df %>% distinct(oras_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Ventura Distribution of Assessments by ORAS Risk Category", fill = "Race") 
```
\newpage
...
m6 <- glm(family = binomial(),any_pretrial_failure_flag ~ vprai_risk_score + race + release_to_pretrial_end, data = race_df)
...
ggplot(risk_df %>% distinct(oras_risk_score, Total, sex) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(Total, "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by ORAS Risk Category", fill = "Gender")
```
\newpage
...
ggplot(risk_df %>% distinct(vprai_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(formatC(Total, big.mark = ","), "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by VPRAI Risk Category", fill = "Gender")    
...
ggplot(risk_df %>% distinct(vprair_risk_score, Total) %>% 
  ...
  geom_col(position = "dodge") +
  geom_text(vjust = .4, aes(label = str_c(formatC(Total, big.mark = ","), "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by VPRAIR Risk Category", fill = "Gender") +
  theme_bw()
```
\newpage
...
ggplot(risk_df %>%
  ...
  theme_bw() +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Distribution of Assessments by PSA Risk Category", fill = "Gender") +
...
ggplot(risk_df %>% distinct(vprair_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(formatC(Total, big.mark = ","), "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Alameda Distribution of Assessments by VPRAIR Risk Category", fill = "Gender")  
```
\newpage
...
ggplot(risk_df %>%
  ...
  # ylim(0,100) +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Los Angeles Distribution of Assessments by PSA Risk Category", fill = "Gender") +
  scale_y_continuous(expand = expansion(mult = c(.1, .25))) 
```
\newpage
...
ggplot(risk_df %>%
  ...
  theme_bw() +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Sacramento Distribution of Assessments by PSA Risk Category", fill = "Gender") +
  scale_y_continuous(expand = expansion(mult = c(.1, .25))) 
```
\newpage
...
ggplot(risk_df %>% distinct(vprai_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(formatC(Total, big.mark = ","), "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "San Joaquin Distribution of Assessments by VPRAI Risk Category", fill = "Gender")    
```
\newpage
...
ggplot(risk_df %>% distinct(vprair_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(formatC(Total, big.mark = ","), "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Santa Barbara Distribution of Assessments by VPRAIR Risk Category", fill = "Gender")  
```
\newpage
...
ggplot(risk_df %>%
  ...
  # ylim(0,100) +
  facet_wrap(~name, scales = "free", ncol = 1) +
  labs(x = "Risk Category", y = "Count", title = "Sonoma Distribution of Assessments by PSA Risk Category", fill = "Gender") +
  scale_y_continuous(expand = expansion(mult = c(.1, .25)))  
```
\newpage
...
ggplot(risk_df %>% distinct(oras_risk_score, Total) %>% 
  ...
  geom_text(vjust = .4, aes(label = str_c(formatC(Total, big.mark = ","), "\n(", percent, "%)")), size = 2.6, position = position_dodge(width = .9)) +
  theme_bw() +
  labs(x = "Risk Category", y = "Count", title = "Ventura Distribution of Assessments by ORAS Risk Category", fill = "Gender") 
```
\newpage
...
m6 <- glm(family = binomial(),any_pretrial_failure_flag ~ vprai_risk_score + sex + release_to_pretrial_end, data = sex_df)
...
# AUC Comparison Example for Sal
```{r}
roc1 <- roc(fta_flag ~ vprair_risk_score, data = eval_df %>% filter(race == "White"), ci = T)
roc2 <- roc(fta_flag ~ vprair_risk_score, data = eval_df %>% filter(race == "Black"), ci = T)
roc.test(roc1, roc2)
```
...
```
# Exploratory
PSA -- looking by release type (judge vs bail vs ?)
\newline
```{r eval=FALSE, include=FALSE}
risk_df <- eval_df %>%
  filter(tool_name == "psa") %>%
  group_by(psa_fta_risk_score, release_type, county) %>%
  select(fta_flag) %>%
  pivot_longer(fta_flag) 
...
risk_df2 <- eval_df %>%
  filter(tool_name == "psa") %>%
  group_by(psa_nca_risk_score, release_type, county) %>%
  select(recid_arrested_flag, recid_filed_flag, recid_convicted_flag) %>%
  pivot_longer(recid_arrested_flag:recid_convicted_flag) 
...
risk_df3 <- eval_df %>%
  filter(tool_name == "psa", !is.na(psa_nvca_risk_score)) %>%
  group_by(psa_nvca_risk_score, release_type, county) %>%
  select(recid_arrest_violent_psa_flag) %>%
  pivot_longer(recid_arrest_violent_psa_flag) 
...
risk_df <- risk_df %>%
  #mutate(release_type = factor(release_type, levels = c("White", "Black", "Hispanic", "Other_Unknown"))) %>%
  filter(release_type %in% c("Unknown_Bail", "OR", "Cite_Release")) %>%
  mutate(name = case_when(name == "fta_flag" ~ "FTA",
                          name == "recid_arrested_flag" ~ "New Arrest",
                          name == "recid_filed_flag" ~ "New Filing",
                          name == "recid_convicted_flag" ~ "New Conviction",
...
ggplot(risk_df) +
  aes(x = psa_risk_score, y = value, color = release_type) +
  geom_smooth(method = "glm", method.args = list(family=binomial), alpha = .2) +
  # geom_line() +
  # geom_point() +
  theme_bw() +
  ...
  facet_wrap(~name, scales = "free") +
  # facet_grid(county~name, scales = "free") +
  labs(x = "Risk Category", y = "Percent", title = "Comparison of Release Type Differences in Logistic Regression Curves--PSA") +
  scale_x_continuous(breaks = 1:6)
...
\newline
```{r, eval=FALSE, include=FALSE}
m1 <- glm(family = binomial(),fta_flag ~ psa_fta_risk_score + race + release_to_pretrial_end + release_type, data = race_df)
m2 <- glm(family = binomial(),recid_arrested_flag ~ psa_nca_risk_score + race + release_to_pretrial_end + release_type, data = race_df)
#m2 <- glm(family = binomial(),recid_arrested_flag ~ psa_nca_risk_score*release_type, data = race_df)

m3 <- glm(family = binomial(),recid_filed_flag ~ psa_nca_risk_score + race + release_to_pretrial_end + release_type, data = race_df)
m4 <- glm(family = binomial(),recid_convicted_flag ~ psa_nca_risk_score + race + release_to_pretrial_end + release_type, data = race_df)
m5 <- glm(family = binomial(),recid_arrest_violent_psa_flag ~ psa_nvca_risk_score + race + release_to_pretrial_end + release_type, data = race_df)
