...
mod <- lm(data = full_bts %>%
            ...
            mutate(book_month = as.factor(month(booking_date))) %>%
             mutate(days_released = pretrial_period_end_date - release_date,
                    charge_hier = scale(as.numeric(if_else(booking_charge_hierarchy %in% c("1000000", "999999"), "Undefined", booking_charge_hierarchy)))), 
           recid_county_or_doj ~ days_released*avg_bts_mob + golive_flag + covid_flag + eb_flag + emerg_flag + charge_hier + county + book_month + arrest_dv_flag + arrest_violent_flag + arrest_violent_psa_flag + arrest_dui_flag + arrest_property_flag + arrest_drug_flag + arrest_serious_flag + arrest_capital_flag + arrest_restrain_flag + arrest_special_flag)
...
mod <- lm(data = full_bts %>%
            ...
            mutate(book_month = as.factor(month(booking_date))) %>%
             mutate(days_released = pretrial_period_end_date - release_date,
                    charge_hier = scale(as.numeric(if_else(booking_charge_hierarchy %in% c("1000000", "999999"), "Undefined", booking_charge_hierarchy)))), 
           fta_flag ~ days_released*avg_bts_mob + golive_flag + covid_flag + eb_flag + emerg_flag + charge_hier + county + book_month + arrest_dv_flag + arrest_violent_flag + arrest_violent_psa_flag + arrest_dui_flag + arrest_property_flag + arrest_drug_flag + arrest_serious_flag + arrest_capital_flag + arrest_restrain_flag + arrest_special_flag)
...
# non-zero bail-eligible MISDO only - with month fixed effect limited to 2019 and 2021
...
mod <- lm(data = full_bts %>%
            ...
            mutate(book_month = as.factor(month(booking_date))) %>%
             mutate(days_released = pretrial_period_end_date - release_date,
                    charge_hier = scale(as.numeric(if_else(booking_charge_hierarchy %in% c("1000000", "999999"), "Undefined", booking_charge_hierarchy)))), 
           recid_county_or_doj ~ days_released*avg_bts_mob + golive_flag + covid_flag + eb_flag + emerg_flag + charge_hier + county + book_month + arrest_dv_flag + arrest_violent_psa_flag + arrest_dui_flag + arrest_property_flag + arrest_drug_flag  + arrest_restrain_flag + arrest_special_flag)
...
mod <- lm(data = full_bts %>%
             ...
             mutate(book_month = as.factor(month(booking_date))), 
           released_pretrial_count ~ mob_pop + golive_flag + covid_flag + eb_flag + emerg_flag + charge_hier + county + arrest_dv_flag + arrest_violent_flag + arrest_violent_psa_flag + arrest_dui_flag + arrest_property_flag + arrest_drug_flag + arrest_serious_flag + arrest_capital_flag + arrest_restrain_flag + arrest_special_flag + book_month)
...
mod <- lm(data = full_bts %>%
             ...
             filter(!is.na(charge_hier)) %>%
             mutate(book_month = as.factor(month(booking_date))), 
           released_pretrial_count ~ mob_pop + golive_flag + covid_flag + eb_flag + emerg_flag + charge_hier + county + arrest_dv_flag + arrest_violent_flag + arrest_violent_psa_flag + arrest_dui_flag + arrest_property_flag + arrest_drug_flag + arrest_serious_flag + arrest_capital_flag + arrest_restrain_flag + arrest_special_flag)
