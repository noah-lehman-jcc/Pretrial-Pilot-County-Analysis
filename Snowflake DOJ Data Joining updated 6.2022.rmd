...
save(sf_df, file = "C:/Work/Pretrial-Pilot-County-Analysis/Snowflake extract for joining 6.17.22.RData")
rm(sf)
```
...
Fix file that errored out in processing
```{r eval=FALSE, include=FALSE}
...
fwrite(df_updated, file="G:/CrimJustice/PretrialAssessmentPilot/ADLS Load/DOJ_Enhanced_Program_Dates 6.20.22.csv")
```
