...
match_df <- full_df %>%
  mutate(pretrial_end_date_doj = if_else(is.na(pretrial_end_date), pretrial_end_date_doj, pretrial_end_date)) %>% #changed this, used to be assigned to pretrial_end_date, need to fix variable names going forward ****************************************************
