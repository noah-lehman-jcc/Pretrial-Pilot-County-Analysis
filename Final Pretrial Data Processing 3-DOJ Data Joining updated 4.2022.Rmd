...
rename_with(~gsub("_DOJ", "", .x), .cols = c(county_DOJ, booking_id_DOJ, booking_key_DOJ, booking_date_DOJ, release_date_DOJ, case_filed_date_DOJ, case_disposition_date_DOJ)) %>%
...
fwrite(test_doj, file="G:/CrimJustice/PretrialAssessmentPilot/final_doj_for_upload to sf 2023.csv")
save(test_doj, file = "G:/CrimJustice/PretrialAssessmentPilot/final_doj_for_upload to sf 2023.RData")

names(all_with_doj_and_recid)
names(test_doj)
all_with_doj_and_recid %>%
  select(contains("end_date"))
load("final_doj_for_upload to sf 2023.RData")
names(test_doj)
