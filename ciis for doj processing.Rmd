...
modocCII <- read.xlsx("G:/CrimJustice/PretrialAssessmentPilot/modocCIIplus.xlsx")
...
```{r}
sf <- fread(file = 'G:/CrimJustice/PretrialAssessmentPilot/SnowflakeCIIDOB 3 21 2022.csv', header = TRUE)
...
```{r}
write.fwf(doj_single, file="senddoj_cii_3_21_2022.txt", sep="", na="NULL",
...
write.fwf(doj_single, file="G:/CrimJustice/PretrialAssessmentPilot/senddoj_cii_3_21_2022.txt", sep="", na="NULL",
rownames=FALSE, colnames=FALSE, justify="left",
formatInfo=FALSE, quoteInfo=TRUE, width=78, eol="\r",
scientific=FALSE)
```
