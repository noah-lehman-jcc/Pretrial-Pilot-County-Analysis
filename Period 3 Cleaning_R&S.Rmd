...
court_charge_4<- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/P3 Submission-Jan 15/41-COURT-02OF03-OCT2020-DEC2020.csv", na.strings=c("NULL",""))   

court_charge_4 <- court_charge_4 %>%
  mutate(BookingNumber = as.character(BookingNumber)) %>%
...
court_hearing_4<- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/P3 Submission-Jan 15/41-COURT-03OF03-OCT2020-DEC2020.csv", na.strings=c("NULL","")) %>%
  mutate_at(vars(contains("date"), DtFile), mdy)
...
#Are the contents mostly complete? 
 ##court_df hardly any CIIs or FBIs but they do have a local_id that is complete. Race misssing
...
##no arrest dates past 9/29/2019 are coming through
summary(court_charge$plea_date)
summary(court_hearing$)
