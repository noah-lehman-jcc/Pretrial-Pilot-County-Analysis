...
court_df_s3 <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sierra/P3 Submission-Jan 15/Pretrial_4_Demographics-07-01-2020thru12-31-2020.xls", range = cell_cols("A:F"))
...
# warrant dates range from 9/22/2020 to 1/5/2021
court_warrant_s3 <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sierra/P3 Submission-Jan 15/Pretrial_2_ScheduledEvents_Warrant-07-01-2020thru12-31-2020.xls" , range = cell_cols("A:G"))
...
#Import Events Table, the P3 period is the first time they have submitted full events data should have data from June 2020 to Dec 2020.  File has 143 obs and hearing result date ranges from 7/21/2020 to 1/5/2021
court_hearings_s3<- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sierra/P3 Submission-Jan 15/Pretrial_5_ScheduledEvents07-01-2020thru12-31-2020.xls", range = cell_cols("A:E")) 
...
# Name Standardization--See pg. xxx for more details. 
names(court_dispos_s) <- c("court_case_id", "case_name", "file_date", "charge_number", "court_charge_level_original", "court_charge_original", "disposition_date", "disposition_type_original", "disposition_manner", "sentence_date", "sentence_type_original", "sentence_amount", "sentence_length", "sentence_length_unit")
...
summary(court_dispos_s$disposition_date)


# read in updated data Obs 248 file date range 7/6/2020-12/29/2020
# sentence date range 7/27/2020 to 12/14/2020 NA's 216

court_dispos_s3 <- read_excel("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/Sierra/P3 Submission-Jan 15/Pretrial_3_Charges-07-01-2020thru12-31-2020.xls", range = cell_cols("A:N"))
...
summary(court_dispos_s3$file_date)
####
```
