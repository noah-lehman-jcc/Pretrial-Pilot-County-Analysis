...
assess_df <- assess_df %>%
  mutate(sex = case_when(sex_original %in% c("Male") ~ "Male",
         ...
         #separate risk score from risk level
         vpraio_risk_level = trimws(gsub("[0-9]|\\(|\\)", "", vpraio_risk_score)),
         vpraio_risk_level = gsub("Average", "Medium", vpraio_risk_level),
...
court_status <- read.csv("Historical Data Submissions/Sonoma/P2 Submission-June 30/SonomaCourt_Case_Status_20200110_1.csv", stringsAsFactors = FALSE) 
