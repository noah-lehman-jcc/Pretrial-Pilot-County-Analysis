...
book_charge <- fread("Historical Data Submissions/Sacramento/P2 Submission-June 30/SacBookingDetail07132020.csv")
book_charge1 <- fread("Historical Data Submissions/Sacramento/SacBookingDetail.csv")
book_charge <- bind_rows(book_charge, book_charge1)
rm(book_charge1)
...
#Booking Dates
book_df <- fread("Historical Data Submissions/Sacramento/P2 Submission-June 30/SacBookingMain07132020.csv")
book_df1 <- fread("Historical Data Submissions/Sacramento/SacBookingMain.csv")
book_df <- bind_rows(book_df, book_df1)
rm(book_df1)
...
book_bail1 <- fread("Historical Data Submissions/Sacramento/SacBail.csv")
book_bail <- bind_rows(book_bail, book_bail1)
rm(book_bail1)
...
court_sentence <- fread("Historical Data Submissions/Sacramento/P2 Submission-June 30/SacSentence.csv")
