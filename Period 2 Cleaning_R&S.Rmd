...
#Keeping the commented out data read in only for original names, this is the old Booking Data but it had column headers. 
# initally San Mateo did not  filter on both bookings and releases in their historical data extract. Extract dates fixed in 8/7/2020        extract Jan 2015-June 30, 2020
