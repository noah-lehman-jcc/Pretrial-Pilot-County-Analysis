...
# Readin Terms and Conditions
  ## it looks like they reconrd conditions the person got, rather than recommended condtions we find multiple lines for the same pretrial Id with different release dates, or release types.
...
#Standardize Factors
  ##ask if violoation reasons (arrest, FTR FTA are only for cases that resulted in termination of supervision)
#assess_df_viol <- assess_df_viol %>%
...
court_charge_3 <- fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/P2 Submission-June 30/41-COURT-02OF03-JUL2020-SEP2020.csv", colClasses = "character") 
