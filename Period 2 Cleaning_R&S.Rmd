...
assess_df_case <- assess_df_case %>%
 mutate(rec_release_flag = if_else(release_recommendation_original %in% c("Release on Own Recognizance",
...
assess_df_case %>%
  count(release_recommendation_original, pretrial_termination_outcome_original)
...
# Readin Terms and Conditions
  ## it looks like they reconrd conditions the person got, rather than recommended condtions 
...
assess_df_terms <- assess_df_terms %>%
         ...
         mutate (condition_drug_test_flag = if_else(grepl("SCRAM|TEST|CONTROLLED SUBSTANCES|DRUG|ALCOHOL|CHEMICAL",
                                                  toupper(Pretrial_Terms_and_Conditions)), 1, 0),
