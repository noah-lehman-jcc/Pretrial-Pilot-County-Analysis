...
#Jail Bookings Data Import--Nevada Jail Data 1/1/2015 to 7/27/2020
  ...
  ## ??? the new data has 20 variables, but the dates for arrest, book and rls came in as times only, also  there were 39 variables in   the extract Cory sent, rather than 19 as before.  I asked cory to give us all the data back to 1/1/2015  ##with the dates corrected in the 39 variable format.
...
```{r eval=FALSE, include=FALSE}
##disposition date in court charge is a charge disposition date rather than a case disposition date, I think we want disposition date from court_df
...
# Jail Bookings Data Import--- San Mateo, 2015-01-01 to 09-30-2020
  ...
  ## New data was submitted on 10/6/2020 it should have IDs used by probation, they added local_id and added booking number again
 
####

# Booking Data
  ## book_df contains one row per booking/charge and includes information on the person as well as the time of booking and release. initally they did not  filter on both bookings and releases in their historical data extract during the time periodS.  They have since fixed this.
# book_df <- fread("Historical Data Submissions/San Mateo/41-SO-01OF01-JAN2015-JUN2019.csv", colClasses = 

####

#San Mateo Jail Data Import
 ## submitted 8/7/2020 to make sure file includes people who where booked or released from Jan 2015-June 30, 2020
...
# Court Cases
court_df <- lapply(c("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-COURT-01OF03-JAN2016-SEP2019.csv", 
                    "G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-COURT-01OF03-OCT2019-DEC2019.csv",
                    "G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/P2 Submission-June 30/41-COURT-01OF03-JAN2020-JUN2020.csv",
                    "G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/P2 Submission-June 30/41-COURT-01OF03-JUL2020-SEP2020.csv"), 
                                     function(x) {
...
court_charge <- bind_rows(court_charge, court_charge_1, court_charge_2, court_charge_3) %>% distinct()

rm(court_charge_1, court_charge_2, court_charge_3)


# Variable name standardization--See pg. xxx for more details.
names(court_charge) <- c("court_docket_id", "court_case_id_original", "file_date", "court_case_type", "court_case_status_original", "court_case_status_date", "book_num", "arrest_date", "arrest_control", "arrest_agency", "offense_id", "charge_id", "charge_num", "offense_date", "court_charge_original", "court_charge_level_original", "court_charge_description", "plea type_original", "plea_date", "disposition_type_original", "disposition_date", "final_date", "sentence_type_original", "sentence_date",  "probation_type", "term_years_probation", "term_months_probation", "term_days_probation", "jail_type", "term_years_jail", "term_months_jail", "term_days_jail")
...
# Court Hearings
 ...
 ## the next two date files have the date in a different format so needed to use mdy
   court_hearing <-
   fread("G:/CrimJustice/PretrialAssessmentPilot/Historical Data Submissions/San Mateo/41-COURT-03OF03-JAN2016-SEP2019.csv") %>%
 ...
 court_hearing <-
   bind_rows(court_hearing, court_hearing_1, court_hearing_2, court_hearing_3) %>% distinct()
