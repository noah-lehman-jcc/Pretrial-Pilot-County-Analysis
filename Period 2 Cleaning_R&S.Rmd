...
# Flag Standardization---See pg. xxx for more details.
 ...
 assess_df <- assess_df %>%
    mutate(assess_flag = if_else(is.na(assessment_date), 0, 1),
         ...
         condition_inperson_flag = if_else(grepl("ENHANCED", toupper(pretrial_release_type_original)), 1, 0),
...
names_df <- names_df %>%
  mutate(
    modified_field = case_when(
      field == "sex_original" ~ "sex",
      field == "race_original" ~ "race",
      field == "release_recommendation_original" ~ "release_recommendation, rec_release_flag",
      ...
      ##field == "release_authorization_original" ~ "release_authorization",
      field == "pretrial_termination_outcome_original" ~ "pretrial_termination_reason, pretrial_termination_outcome, pretrial_violation_flag",
      ##field == "court_date_reminder_original" ~ "court_date_reminder_flag",
      ##field =="other_pretrial_service_original" ~ "transit_service_flag",
...
## we left off here on the assessment codebook for San Mateo
