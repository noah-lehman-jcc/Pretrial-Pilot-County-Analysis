  ...
  mutate(
    hearing_type = case_when(
      hearing_type_original %in% c(
        "ARRAIGNMENT","WARRANT ARRAIGNMENT", "ARRAIGNMENT ON VIOLATION OF PROBATION (VOP)", "CONTINUED ARRAIGNMENT", "ARRAIGNMENT ON VIOLATION OF            PROBATION-FELONY", "ARRAIGNMENT ON INFORMATION", "ARR ON PETITION TO REVOKE/MODIFY PAROLE",
...
Assessment Data (Probation) Go live date was Jan 23, 2020
```{r}
...
##Period 2 assessment diagnostics 
